...
# Добавляем JWT аутентификацию для Swagger
from rest_framework_simplejwt.authentication import JWTAuthentication
from drf_yasg.inspectors import SwaggerAutoSchema

class JWTSwaggerAutoSchema(SwaggerAutoSchema):
    def get_security_requirements(self, security_requirements=None):
        return [{'Bearer': []}]

schema_view._swagger_auto_schema = JWTSwaggerAutoSchema